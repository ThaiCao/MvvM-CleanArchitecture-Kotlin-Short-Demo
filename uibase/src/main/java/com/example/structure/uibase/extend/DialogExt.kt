...
import com.example.structure.uibase.dialogfragment.DialogFragmentLifecycleObserver
import com.example.structure.uibase.dialogfragment.InfoDialog
...
fun <D : DialogFragment> Fragment?.showDialogFragment(tag: String, dialog: () -> D): D? {
    this?.activity?.currentFocus?.hideKeyboard()
